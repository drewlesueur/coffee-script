(function() {
  ...
  exports.Value = Value = (function() {
    ...
    Value.prototype.compileNode = function(o, lvl, extra) {
      ...
      if (useLookup && !(extra != null ? extra.assignment : void 0)) {
        for (_i = 0, _len = props.length; _i < _len; _i++) {
          prop = props[_i];
          code = prop.compile(o, null, code, extra);
        }
      } else if (useLookup && (extra != null ? extra.assignment : void 0) && props.length > 0) {
        useLookup = false;
        this.propsLastOne = props.slice(props.length - 1, props.length)[0].compile(o);
        if (this.propsLastOne.substr(0, 1) === ".") {
          this.propsLastOne = this.propsLastOne.substr(1);
        } else if (this.propsLastOne.substr(0, 1) === "[") {
          this.propsLastOne = this.propsLastOne.substring(2, this.propsLastOne.length - 2);
        }
        useLookup = true;
  ...
  exports.Access = Access = (function() {
    ...
    Access.prototype.compile = function(o, lvl, baser, extra) {
      ...
      if (useLookup) {
        ...
        return "" + (utility('lookup')) + "(" + baser + this.proto + ", " + name + ")";
      } else {
  ...
  exports.Index = Index = (function() {
    ...
    Index.prototype.compile = function(o, lvl, baser, extra) {
      if (useLookup && !(extra != null ? extra.assignment : void 0)) {
        ...
        return "" + (utility('lookup')) + "(" + baser + ", " + (this.index.compile(o, LEVEL_PAREN)) + ")";
      } else {
  ...
  exports.Op = Op = (function() {
    ...
    Op.prototype.compileUnary = function(o) {
      ...
      if (useLookup && (op === '++' || op === '--' || op === 'delete' || op === 'new')) {
        useLookup = false;
