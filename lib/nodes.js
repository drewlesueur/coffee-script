(function() {
  var Access, Arr, Assign, Base, Call, Class, Closure, Code, Comment, Existence, Expressions, Extends, For, IDENTIFIER, IS_STRING, If, In, Index, LEVEL_ACCESS, LEVEL_COND, LEVEL_LIST, LEVEL_OP, LEVEL_PAREN, LEVEL_TOP, Literal, NEGATE, NO, Obj, Op, Param, Parens, Push, Range, Return, SIMPLENUM, Scope, Slice, Splat, Switch, TAB, THIS, TRAILING_WHITESPACE, Throw, Try, UTILITIES, Value, While, YES, all_funcs, compact, del, ends, extend, flatten, last, merge, multident, starts, unfoldSoak, utility, __metabeta__, _ref;
  ...
  exports.Access = Access = function() {
    ...
    Access.prototype.compile = function(o) {
      ...
      if (__metabeta__) {
        return this.proto + (IS_STRING.test(name) ? ".__meta.get(\"" + name + "\")" : ".__meta.get(get(\"" + name + "\")");
      } else {
