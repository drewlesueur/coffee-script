(function() {
  ...
  exports.Base = Base = (function() {
    ...
    Base.prototype.compile = function() {
      var args, lvl, node, o;
      o = arguments[0], lvl = arguments[1], args = 3 <= arguments.length ? __slice.call(arguments, 2) : [];
      o = extend({}, o);
      if (lvl) {
        o.level = lvl;
      }
      ...
      if (o.level === LEVEL_TOP || !node.isStatement(o)) {
        return node.compileNode.apply(node, [o, lvl].concat(__slice.call(args)));
      } else {
        return node.compileClosure.apply(node, [o, lvl].concat(__slice.call(args)));
      }
    };
  ...
  exports.Value = Value = (function() {
    ...
    Value.prototype.compileNode = function(o, lvl, extra) {
      var code, prop, props, _i, _j, _k, _l, _len, _len2, _len3, _len4;
      ...
      if (useGetSet && !(extra != null ? extra.assignment : void 0)) {
        for (_i = 0, _len = props.length; _i < _len; _i++) {
          prop = props[_i];
          code = prop.compile(o, null, code, extra);
        }
      } else if (useGetSet && (extra != null ? extra.assignment : void 0) && props.length > 0) {
        this.propsLastOne = props.slice(props.length - 1, props.length)[0].compile(o, null, null, {
          plainName: true,
          disableuseGetSet: true
        });
        ...
        for (_k = 0, _len3 = props.length; _k < _len3; _k++) {
          prop = props[_k];
          code += prop.compile(o, null, code, extra);
        }
      } else {
        for (_l = 0, _len4 = props.length; _l < _len4; _l++) {
          prop = props[_l];
          code += prop.compile(o);
        }
      }
  ...
  exports.Call = Call = (function() {
    ...
    Call.prototype.compileNode = function(o) {
      var arg, args, code, retValue, _ref2;
      ...
      if (this.isSuper) {
        ...
        if (useGetSet) {
          if (this.isNew) {
            useGetSet = false;
            retValue = 'new ' + this.variable.compile(o, LEVEL_ACCESS) + ("(" + args + ")");
            useGetSet = true;
            return retValue;
          } else {
            return this.variable.compile(o, LEVEL_ACCESS) + ("(" + args + ")");
          }
        } else {
    ...
    Call.prototype.compileSplat = function(o, splatArgs) {
      var base, fun, idt, innerCode, name, ref;
      if (this.isSuper) {
  ...
  exports.Access = Access = (function() {
    ...
    Access.prototype.compile = function(o, lvl, baser, extra) {
      var name;
      name = this.name.compile(o);
      if (useGetSet && !(extra != null ? extra.disableuseGetSet : void 0)) {
        name = IDENTIFIER.test(name) ? "\"" + name + "\"" : "" + name;
        return "" + (utility('get')) + "(" + baser + this.proto + ", " + name + ")";
      } else if (extra != null ? extra.plainName : void 0) {
  ...
  exports.Index = Index = (function() {
    ...
    Index.prototype.compile = function(o, lvl, baser, extra) {
      if (useGetSet && !(extra != null ? extra.disableuseGetSet : void 0)) {
        if (this.proto) {
          baser = baser + ".prototype";
        }
        return "" + (utility('get')) + "(" + baser + ", " + (this.index.compile(o, LEVEL_PAREN)) + ")";
      } else if (extra != null ? extra.plainName : void 0) {
  ...
  exports.Slice = Slice = (function() {
    ...
    Slice.prototype.compileNode = function(o, lvl, baser, extra) {
      ...
      if (useGetSet) {
        return "" + baser + ".slice(" + fromStr + (toStr || '') + ")";
      } else {
  ...
  exports.Assign = Assign = (function() {
    ...
    Assign.prototype.compileNode = function(o) {
      ...
      if (useGetSet && ((_ref6 = this.variable.properties) != null ? _ref6.length : void 0) > 0) {
  ...
  exports.Op = Op = (function() {
    ...
    Op.prototype.compileUnary = function(o) {
      ...
      if (useGetSet && (op === '++' || op === '--' || op === 'delete' || op === 'new')) {
        useGetSet = false;
