(function() {
  var Access, Arr, Assign, Base, Call, Class, Closure, Code, Comment, Existence, Expressions, Extends, For, IDENTIFIER, IS_STRING, If, In, Index, LEVEL_ACCESS, LEVEL_COND, LEVEL_LIST, LEVEL_OP, LEVEL_PAREN, LEVEL_TOP, Literal, NEGATE, NO, Obj, Op, Param, Parens, Push, Range, Return, SIMPLENUM, Scope, Slice, Splat, Switch, TAB, THIS, TRAILING_WHITESPACE, Throw, Try, UTILITIES, Value, While, YES, all_funcs, compact, del, ends, extend, flatten, last, last_var, merge, multident, starts, unfoldSoak, utility, __metabeta__, _ref;
  ...
  exports.Expressions = Expressions = function() {
    ...
    Expressions.prototype.className = "Expressions";
  ...
  exports.Value = Value = function() {
    ...
    Value.prototype.className = "Value";
  ...
  exports.Call = Call = function() {
    ...
    Call.prototype.compileNode = function(o) {
      ...
      if (this.isSuper) {
        ...
        if (__metabeta__) {
          return 'call(' + this.variable.compile(o, LEVEL_ACCESS) + (", [" + args + "]") + ")";
        } else {
  ...
  exports.Extends = Extends = function() {
    ...
    Extends.prototype.className = "Extends";
  ...
  exports.Access = Access = function() {
    ...
    Access.prototype.className = "Access";
    Access.prototype.children = ['name'];
    Access.prototype.compile = function(o) {
      var name;
      name = this.name.compile(o);
      if (__metabeta__) {
        return this.proto + (IS_STRING.test(name) ? ".__meta.get(get( \"" + name + "\"))" : ".__meta.get(\"" + name + "\")");
      } else {
  ...
  exports.Index = Index = function() {
    ...
    Index.prototype.className = "Index";
    Index.prototype.children = ['index'];
    Index.prototype.compile = function(o) {
      if (__metabeta__) {
        return (this.proto ? '.prototype' : '') + (".__meta.get( " + (this.index.compile(o, LEVEL_PAREN)) + ")");
      } else {
  ...
  exports.Assign = Assign = function() {
    ...
    Assign.prototype.className = "Assign";
    ...
    Assign.prototype.compileNode = function(o) {
      ...
      if (__metabeta__ === true) {
        val = "set(" + name + (" " + (this.context || ', ') + " ") + val + ")";
      } else {
  ...
  exports.Code = Code = function() {
    ...
    __extends(Code, Base);
    Code.prototype.className = "Code(func def)";
    ...
    Code.prototype.compileNode = function(o) {
      ...
      if (__metabeta__) {
        all_funcs.push(code);
        code = "make_func(all_funcs[" + (all_funcs.length - 1) + "], scope)";
      }
      if (this.ctor) {
  ...
  exports.Param = Param = function() {
    ...
    Param.prototype.className = "Param";
  ...
  exports.Splat = Splat = function() {
    ...
    Splat.prototype.className = "Splat";
  ...
  exports.Existence = Existence = function() {
    ...
    Existence.prototype.className = "Existance";
  ...
  exports.Parens = Parens = function() {
    ...
    Parens.prototype.className = "Parens";
