(function() {
  ...
  exports.Base = Base = (function() {
    ...
    Base.prototype.compile = function() {
      ...
      if (o.level === LEVEL_TOP || !node.isStatement(o)) {
        return node.compileNode.apply(node, [o].concat(__slice.call(args)));
      } else {
        return node.compileClosure.apply(node, [o].concat(__slice.call(args)));
      }
    };
  ...
  exports.Value = Value = (function() {
    ...
    Value.prototype.compileNode = function(o, extra) {
      ...
      if (useLookup && !(extra != null ? extra.assignment : void 0)) {
        for (_i = 0, _len = props.length; _i < _len; _i++) {
          prop = props[_i];
          code = prop.compile(o, code, extra);
        }
      } else if (useLookup && extra.assignment) {
  ...
  exports.Access = Access = (function() {
    ...
    Access.prototype.compile = function(o, baser, extra) {
      var name;
      name = this.name.compile(o);
      if (useLookup && !(extra != null ? extra.assignment : void 0)) {
        utility("lookup");
        return this.proto + ("__lookup(" + baser + ", \"" + name + "\")");
      } else {
  ...
  exports.Index = Index = (function() {
    ...
    Index.prototype.compile = function(o, baser) {
      if (useLookup) {
        return (this.proto ? '.prototype' : '') + ("__lookup(" + baser + ", " + (this.index.compile(o, LEVEL_PAREN)) + ")");
      } else {
  ...
  exports.Assign = Assign = (function() {
    ...
    Assign.prototype.compileNode = function(o) {
      ...
      if (useLookup) {
        console.log(this.variable.constructor.toString());
      }
